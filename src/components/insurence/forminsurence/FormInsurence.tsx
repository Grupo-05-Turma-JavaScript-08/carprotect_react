...
import { Calendar, ShieldCheck, Tag } from "@phosphor-icons/react";
...
function FormInsurance() {
    ...
    async function salvarSeguro(e: FormEvent<HTMLFormElement>) {
        ...
        // validação simples
        if (!insurance.title || !insurance.description || !insurance.premiumPorcent || !insurance.effectiveDate || !insurance.expirationDate) {
           ToastAlerta("Preencha os campos obrigatórios!", "warning");
            ...
            if (id !== undefined) {
                try {
                    await atualizar(`insurance`, insurance, setInsurance);
                ...
                try {
                    await cadastrar(`insurance`, insurance, setInsurance);
                            ...
                            <form className="mx-auto w-full space-y-8" onSubmit={salvarSeguro}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="premiumPorcent" className="flex items-center gap-2 text-sm font-medium text-[#96A3AB]">
                                                <Tag size={16} className="text-[#056174]" />
                                                % do Prêmio *
                                            </label>
                                            <input
                                                ...
                                                value={insurance.premiumPorcent}
                                                onChange={atualizarEstado}
                                                className="w-full px-4 py-3 bg-[#678391]/50 border border-[#96A3AB]/50 rounded-xl text-[#034153] placeholder-[#96A3AB] focus:outline-none focus:ring-2 focus:ring-[#76AABF]/50 focus:border-[#76AABF]/50 transition-all duration-200"
                                            />
                                        </div>
                                        ...
                                        <div className="space-y-2 flex flex-row gap-5">
                                            <div className="flex flex-col gap-2">
                                                <label htmlFor="purchaseDate" className="flex items-center gap-2 text-sm font-medium text-[#96A3AB]">
                                                    <Calendar size={16} className="text-[#056174]" />
                                                    Data de Inicio *
                                                </label>
                                                <input
                                                    type="date"
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <label htmlFor="expirationDate" className="flex items-center gap-2 text-sm font-medium text-[#96A3AB]">
                                                    <Calendar size={16} className="text-[#056174]" />
                                                    Data de Expiração *
                                                </label>
                                                <input

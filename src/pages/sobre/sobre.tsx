...
function Sobre() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6 font-sans bg-gradient-to-br from-[#f7f9fb] to-[#e8eef3]">
      {/* Sobre Nós + Imagem lado a lado */}
  <div className="w-full max-w-6xl mb-16 flex flex-col md:flex-row items-stretch justify-center py-12 mt-8">
        <div className="flex-1 flex flex-col justify-center text-left px-8 md:px-12 lg:px-16 py-8">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-8 text-[#034153]">Sobre Nós</h1>
        ...
        <div className="flex-1 flex justify-center items-center py-8 px-4 relative">
          <div className="absolute inset-0 flex justify-center items-center z-0">
            <div className="w-72 h-72 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-[#96A3AB] to-[#76AABF] opacity-30"></div>
          </div>
          <img 
            src="/equipe.jpg" 
            alt="Equipe de Atendimento" 
            className="w-full max-w-md h-auto object-cover rounded-2xl relative z-10 transform transition-transform duration-500 hover:scale-105" 
          />
        </div>
      </div>
      
      {/* Vídeo */}
      <div className="w-full max-w-4xl bg-gradient-to-r from-[#034153] to-[#056174] p-1 rounded-2xl shadow-xl mb-16">
      ...
      <div className="w-full max-w-5xl mb-16">
        <h2 className="font-bold text-2xl md:text-3xl mb-10 text-center text-[#034153]">NOSSA MISSÃO, VISÃO E VALORES</h2>
